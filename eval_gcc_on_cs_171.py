...
metric = evaluate.load('mean_iou', experiment_id='gcc_cs_171')
##################################################################
...
##################################################################
# Dataset Class
class CS171Dataset(torch.utils.data.Dataset):
...
dataset = CS171Dataset('data/cs-171')
dataloader = torch.utils.data.DataLoader(dataset, batch_size=BATCH_SIZE, shuffle=False)
CLASSES = []
with open('data/cs-171/ids2label.txt', 'r') as f:
    for line in f:
...
torch.save(preds, f'eval_result/cs_171_pred.pt')
